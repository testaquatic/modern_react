...
const krLocale: yup.LocaleObject = {
    mixed: {
        ...
        oneOf: (param) =>
            `${param.label}은/는 ${param.values} 중 하나여야 합니다.`,
    },
    string: {
        length: (param) =>
            `${param.label}은/는 ${param.length}글자여야 합니다.`,
        min: (param) =>
            `${param.label}은/는 ${param.min}글자 이상이어야 합니다.`,
        max: (param) => `${param.label}은/는 ${param.max}글자 이하여야 합니다.`,
        matches: (param) =>
            `${param.label}은/는 ${param.regex} 형식과 일치해야 합니다.`,
    ...
    number: {
        ...
        lessThan: (param) =>
            `${param.label}은/는 ${param.less} 보다 작아야 합니다.`,
        moreThan: (param) =>
            `${param.label}은/는 ${param.more} 보다 커야 합니다.`,
    ...
    date: {
        ...
        max: (param) =>
            `${param.label}은/는 ${param.max}보다 이전이어야 합니다.`,
    },
};
